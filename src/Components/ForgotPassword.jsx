  ...
  async function sendDataToMail(values) {
    ...
    try {
      const response = await axios.post(
        "https://blog-backend-lfz3.onrender.com/api/auth/forgotpassword",
        values 
      );
      ...
      <div className="container min-vh-100 d-flex align-items-center justify-content-center py-5 py-md-0">
        <div className="content row gx-0">
          <div className="col-md-5"> 
            <div className="text-dark h-100 d-flex align-items-center justify-content-center flex-column p-5 text-center" style={{backgroundColor:'#e3f2fd'}}>
            ...
            <div className="text-center p-5">
              ...
              <form onSubmit={formik.handleSubmit}>
                ...
                <button
                  ...
                  id="change"
                  type="submit"
                  className="btn btn-outline-primary rounded-pill text-center mt-3 w-100"
                >
                  {loading ? (
