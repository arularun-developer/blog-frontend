  ...
  async function sendData(values) {
    ...
    try {
      const response = await axios.post(
        `https://blog-backend-lfz3.onrender.com/api/auth/register`,
        values
      );
        ...
        <div className="content row gx-0">
          ...
          <div className="col-md-7 bg-light">
            <div className="text-center p-5">
              <h1 className="text-main fw-bolder">Create <span className="text-primary">Account</span></h1>
              <form onSubmit={formik.handleSubmit}>
                ...
                <button
                  ...
                  id="changeR"
                  type="submit"
                  className="btn btn-primary rounded-pill text-center mt-3 w-100"
                >
                  {loading ? (
